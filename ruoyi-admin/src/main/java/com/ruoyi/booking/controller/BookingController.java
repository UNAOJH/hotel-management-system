...
public class BookingController extends BaseController
{
    ...
    @Log(title = "预订信息", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, Booking booking)
    {
        ...
        util.exportExcel(response, list, "预订信息数据");
    }
    ...
    @Log(title = "预订信息", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "预订信息", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "预订信息", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
